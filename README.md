# PROYECTO NOTUS THE MOVIE DB
En esta página se puede consultar las peliculas y actores más populares, ademas de poder ver las peliculas que valoraste y tus favoritas.

# Autores 
  ## Arturo Céspedes Pedrazas  | Github : [Perfil de github](https://github.com/ArturoCes)
  
  ## Valentin Tola Rodriguez | Github : [Perfil de github](https://github.com/titinToro)
  
# Funcionalidades
 
[PÁGINA PRINCIPAL](src/imgs/1.jpg) | [DETALLES](src/imgs/2.jpg) | [VOTACION](src/imgs/3.jpg) | [PELICULAS FAVORITAS](src/imgs/4.jpg) | [ACTORES](src/imgs/5.jpg)
